      ...
      <div className="page-container">
        <Message>
          ...
          <p>
            ...
            developed in 2017 by Josh Humpherys as part of his Senior Integration Project for Covenant College.
          </p>
          <p>
            The application currently supports modeling finite state machines, pushdown automata, and Turing machines.
            Additionally, users can step through or run inputs on finite state machines and Turing machines.
            Automata can be downloaded into special files so that they can be shared with others or uploaded later.
          ...
          <p>
            Despite a substantial feature set, there is always more that can be added. The application does not yet
            support running or stepping through inputs on Pushdown automata. Similarly, regular expressions can be
