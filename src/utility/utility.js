...
export const getEmptyStringSymbol = emptyStringSymbolConstant => {
  switch(emptyStringSymbolConstant) {
    case emptyStringSymbols.LAMBDA:
      return '\u03BB';
    case emptyStringSymbols.EPSILON:
      return '\u03B5';
  }
};

export const getAlternationSymbol = alternationSymbolConstant => {
  switch(alternationSymbolConstant) {
    case alternationSymbols.PIPE:
      return '|';
    case alternationSymbols.UNION:
      return '\u222A';
    case alternationSymbols.PLUS:
      return '+';
    case alternationSymbols.LOGICAL_OR:
      return '\u2228';
  }
};